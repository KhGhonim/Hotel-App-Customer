...
export default function ReservationConfirmation() {
  ...
  useEffect(() => {
    ...
    try {
      const fetchData = async () => {
        const response = await fetch(`/api/reservation/oneRoom?q=${roomID}`, {
          method: "GET",
          headers: {
  ...
  const handleConfirmAndPay = async () => {
    ...
    const InsertBooking = await fetch(`/api/reservation/accommodation`, {
      method: "POST",
    ...
    // In a real application, you would also trigger the email sending here
