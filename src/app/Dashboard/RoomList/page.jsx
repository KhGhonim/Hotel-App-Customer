  ...
  return (
    ...
    <div className="mb-6 flex items-center justify-between">
      <div className="flex space-x-4">
        ...
        <button
          className={`rounded-md px-4 py-2 ${
            filter === 'ACTIVE' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-800'
          }`}
        ...
        <button
          className={`rounded-md px-4 py-2 ${
            filter === 'BOOKED' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-800'
          }`}
          ...
          {sortedRooms.map((room) => (
            <tr key={room.id} className="border-b">
              ...
              <td className="px-4 py-2">
                <img src={room.image} alt={room.name} className="h-16 w-24 rounded object-cover" />
              </td>
              ...
              <td className="px-4 py-2">
                <span
                  className={`rounded-full px-2 py-1 text-xs ${
                    room.status === 'ACTIVE' ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'
                  }`}
                >
                  {room.status}
                </span>
